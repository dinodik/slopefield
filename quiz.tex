...
\begin{figure}[!hbt]
    ...
    \def\width{6.2cm} \def\height{6.2cm} % size of each slope field plot
    ...
    \newcommand\slopefield[1]{
        ...
        \def\domainMin{-3}
        \def\domainMax{3}
        \def\ticks{\domainMin+1,...,\domainMax-1}
        ...
        \begin{axis}[view = {0}{90}, % set camera to point towards x-y plane
            ...
            \node[anchor=north west, fill=white] at (rel axis cs:0,1) {\showFieldNumber.};
            % plot outer box
            \draw[ultra thick] (rel axis cs:0,0) -- (rel axis cs:1,0)
    ...
    \newcounter{fieldNumber} % counter for the question/field number
